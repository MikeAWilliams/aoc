...
TEST_CASE("ParseAGame", "[day2]") {
    ...
    result = ParseAGame(
        "Game 100: 1 blue, 1 red, 1 green; 8 blue, 1 green; 1 green, "
...
TEST_CASE("GameIsPossible", "[day2]") {
    ...
    REQUIRE(GameIsPossible(
        ...
        maxOfEachCube));
    REQUIRE_FALSE(GameIsPossible(
        ParseAGame("Game 3: 8 green, 6 blue, 20 red; 5 blue, "
                   "4 red, 13 green; 5 green, 1 red"),
        maxOfEachCube));
    REQUIRE_FALSE(GameIsPossible(
        ParseAGame("Game 4: 1 green, 3 red, 6 blue; 3 green, "
...
TEST_CASE("GetMinCubesToPlayGame", "[Day2]") {
    ...
    REQUIRE(
        CubeData{1, 3, 4} ==
        GetMinCubesToPlayGame(ParseAGame("Game 2: 1 blue, 2 green; 3 green, 4 "
                                         "blue, 1 red; 1 green, 1 blue")));
    REQUIRE(
        CubeData{20, 13, 6} == GetMinCubesToPlayGame(ParseAGame(
                                   "Game 3: 8 green, 6 blue, 20 red; 5 blue, "
                                   "4 red, 13 green; 5 green, 1 red")));
    REQUIRE(
        CubeData{14, 3, 15} == GetMinCubesToPlayGame(ParseAGame(
...
TEST_CASE("Solve part 2 simple", "[Day2]") {
    REQUIRE(
        2286 == SolvePart2(std::vector<std::string>{
                    "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
                    "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 "
                    "green, 1 blue",
                    "Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 "
...
int Solve(
    const std::vector<std::string>& lines, const CubeData& maxOfEachCube) {
    int result = 0;
